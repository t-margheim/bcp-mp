...
var Collects = map[string]Prayer{
	...
	"Monday": {
		Name: "A Collect for the Renewal of Life",
		Content: `<p>O God, the King eternal, whose light divides the day from the 
	...
	"Tuesday": {
		Name: "A Collect for Peace",
		Content: `<p>O God, the author of peace and lover of concord, to know 
	...
	"Wednesday": {
		Name: "A Collect for Grace",
		Content: `<p>Lord God, almighty and everlasting Father, you have 
		...
		your purpose; through Jesus Christ our Lord. <em>Amen. </em></p>
		`,
	},
	"Thursday": {
		Name: "A Collect for Guidance",
		Content: `<p>Heavenly Father, in you we live and move and have our 
	...
	"Friday": {
		Name: "A Collect for Fridays",
		Content: `<p>Almighty God, whose most dear Son went not up to joy but 
		first he suffered pain, and entered not into glory before he 
		was crucified: Mercifully grant that we, walking in the way 
		of the cross, may find it none other than the way of life and 
		peace; through Jesus Christ our Lord. <em>Amen.</em></p>
		`,
	},
	"Saturday": {
		Name: "A Collect for Saturdays",
		Content: `<p>Almighty God, who after the creation of the world rested 
